    ...
    <div>
      <div className="page-header">
        <div className="page-header-left">
          ...
          <p>
            {currentProject?.project?.name} · Track what changed vs baseline
          </p>
        </div>
        <button
        ...
        >
          {loadingAnalysis ? (
            ...
            <>
              <GitPullRequest size={16} /> Analyze Changes vs Baseline
            </>
          )}
        </button>
      </div>
                  ...
                  {analysis.deviations.map((d, i) => (
                    <div
                      ...
                      style={{
                        padding: "12px 0",
                        borderBottom:
                          i < analysis.deviations.length - 1
                    ...
                    >
                      ...
                      >
                        ...
                        <span
                          className={`badge badge-${d.severity}`}
