    ...
    >
      <div className="modal modal-md">
        ...
        >
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        height: 24,
                        fontSize: 10,
                        background: `hsl(${u.name.charCodeAt(0) * 40}, 50%, 50%)`,
                        overflow: "hidden",
                      }}
                    >
                      {u.avatar ? (
          ...
          >
            {loading
              ? "Creating Intelligence Sync..."
              : "Schedule Syncup & Invite"}
          </button>
        </form>
      </div>
    </div>
            ...
            <div style={{ flex: 1 }}>
              ...
              >
                <input
                  type="checkbox"
                  checked={useVoiceAi}
                  onChange={(e) => setUseVoiceAi(e.target.checked)}
                />
                <span style={{ fontSize: 13, color: "var(--text-secondary)" }}>
                  Apply Speaker Diarization (Voice Identity)
                </span>
              </label>
            </div>
          </div>
            ...
            {results.map((u) => (
              ...
              >
                ...
                <button
                  ...
                  onClick={() => inviteToMeeting(meeting.id, u.id)}
                >
                  Invite
                </button>
              </div>
    ...
    <div>
      <div className="page-header">
        ...
        <div style={{ display: "flex", gap: 12 }}>
          ...
          >
            <button
              className={`btn btn-sm ${activeView === "meetings" ? "btn-primary" : "btn-ghost"}`}
          ...
          {invitations.length > 0 && (
            ...
            >
              <div className="card-title" style={{ color: "var(--primary)" }}>
                <Bell size={16} /> Lời mời tham gia họp ({invitations.length})
              </div>
              <div
                style={{
                  display: "flex",
            ...
            {meetings.map((m) => {
              ...
              const dec =
                typeof m.decisions === "string"
                  ...
                  : m.decisions || [];
              const plan =
                typeof m.next_steps_plan === "string"
                  ? JSON.parse(m.next_steps_plan || "[]")
                  : m.next_steps_plan || [];
              const nextMeet =
                typeof m.next_meeting_proposal === "string"
                  ? JSON.parse(m.next_meeting_proposal || "{}")
                  : m.next_meeting_proposal || {};
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    >
                      <span
                        className={`badge ${m.status === "completed" ? "badge-success" : "badge-in_progress"}`}
                  ...
                  {!isAssigned ? (
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <Brain size={14} className="text-primary" /> AI
                          Summary & Sentiment
                        </div>
                        <div
                          style={{
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          Waiting for syncup to complete...
                        </div>
                      </div>
                      <div style={{ display: "flex", gap: 8 }}>
                ...
                {logs.map((log) => (
                  ...
                  >
                    <div
                      className="avatar"
                      style={{
                        background: `hsl(${log.user_name?.charCodeAt(0) * 40}, 50%, 50%)`,
                        width: 32,
                        height: 32,
                        overflow: "hidden",
                      }}
